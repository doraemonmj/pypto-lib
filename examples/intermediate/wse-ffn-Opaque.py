...
def build_wse_ffn_program(
    ...
    class WseFFN:
        ...
        def wse_ffn(
            ...
            # orchestration scope: allocate scratch buffer
            ffn_scratch = pl.create_tensor([BATCH_SIZE, INTER_SIZE], dtype=pl.BF16)

            # spmd body is implicitly InCore
            for block_id in pl.spmd(SPMD_BLOCKS, name_hint="ffn_kernel"):
                b0 = block_id * BATCH_TILE
